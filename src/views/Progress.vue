<template>
    <div :class="['pageContent', {'is-paused': pagePaused}]">
        <Header>
            <slot>Progress</slot>
            <div slot="details">
                <div :class="['season',{'disabled': seasons.length <= 1}]">
                    <select
                ...
                <div class="card">
                    <div class="roles">
                        <div class="roles__item">
                            <div
                                :class="['roleBtn', {'isActive': selectedRole === 'tank'}]"
                                @click="switchList('tank')"
                                ><span class="roleBtn__icon roleBtn__icon--tank"><IconTank/></span>Tank</div>
                        </div>
                        <div class="roles__item">
                            <div
                                :class="['roleBtn', {'isActive': selectedRole === 'damage'}]"
                                @click="switchList('damage')"
                                ><span class="roleBtn__icon roleBtn__icon--damage"><IconDamage/></span>Damage</div>
                        </div>
                        <div class="roles__item">
                            <div
                                :class="['roleBtn', {'isActive': selectedRole === 'support'}]"
                                @click="switchList('support')"
                                ><span class="roleBtn__icon roleBtn__icon--support"><IconSupport/></span>Support</div>
                        </div>
                    </div>
                </div>
...
import IconTank from '@/components/icons/competitive/Tank.vue';
import IconDamage from '@/components/icons/competitive/Damage.vue';
