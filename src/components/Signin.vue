        ...
        <transition-group :name="slide" mode="out-in">
            <div v-if="!slided" class="signin" :key="0">
                ...
                <div class="mainContent">
                    <div class="mainContent__visual"></div>
                    <div class="mainContent__msg">
                        <p class="mainContent__msg__head">OverFlect</p>
                        <p class="mainContent__msg__txt">
                            OverFlect is a tool for monitoring your individual
                            performance in
                            <a
                    ...
                    <div class="mb-3">
                        ...
                        <div class="u-tac">
                            <a @click="skip" class="link link-continue"
                                >Watch without login</a
                            >
                        </div>
                    </div>
                </div>
            ...
            <div v-if="slided" class="signin" :key="1">
                <div class="topNav">
                    <div class="topNav__cell topNav__cell--aside">
                        <a href="" class="backIcon" @click.prevent="backSlide">
                            ...
                            >
                                <path
                                    d="M2.75825 9.07203L9.72271 1.94223C10.166 1.48866 10.1573 0.765881 9.70516 0.325481C9.25305 -0.119308 8.53027 -0.103214 8.08841 0.343039L0.32654 8.29218C-0.116786 8.74575 -0.106544 9.47 0.344098 9.90893L8.29324 17.6737C8.51564 17.8903 8.80534 18 9.09357 18C9.39059 18 9.6876 17.883 9.91146 17.6547C10.3548 17.2026 10.3431 16.4798 9.8939 16.0394L2.75825 9.07203Z"
                                    fill="white"
                                />
                            </svg>
                        </a>
                    </div>
                    <div class="topNav__cell topNav__cell--center">
                        Verification
                    </div>
                ...
                <div class="mainContent">
                    ...
                    <div class="mainContent__msg">
                        ...
                        <p class="mainContent__msg__txt">
                            Enter your password to get access to edit mode
                        </p>
                    </div>
                    <form class="mainContent__card">
                        ...
                        <transition name="error" mode="out-in">
                            <p class="mainContent__card__error" v-if="alert">
                                {{ error }}
                            </p>
                        </transition>
                        <button
                            type="submit"
                            class="mainContent__card__btn"
