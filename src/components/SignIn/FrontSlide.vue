<template>
  <div>
    <div class="frontVisual">
      <h1 class="frontVisual__ttl">OverFlect</h1>
    ...
    <div class="control">
      <button type="button" class="control__connect" @click.prevent="nextSlide">
        Connect
      </button>
      <a @click="skip" class="control__skip">Watch without sign in</a>
    </div>
  </div>
</template>
